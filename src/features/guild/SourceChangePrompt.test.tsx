...
it('never rewrites claimed work without source consent, and preserves historical tasks',()=>{
 ...
 const source={kind:'pin' as const,title:'Craft test',source:'test',requirement:'personal:v1:one',quantity:4,checksum:'quantity-v1:4'};
 ...
 expect(onSave).toHaveBeenCalledWith({p_requested:4,p_checksum:'quantity-v1:4',p_source:'test',p_source_requirement:'personal:v1:one',p_reconfirm:true});
